CREATE DATABASE IF NOT EXISTS `zhihu_article`;
USE zhihu_article;
...
insert into article(title, content, author_id, like_num, publish_time) values ('文章标题1', '文章内容1', 1, 1, '2025-01-9 15:01:01');
insert into article(title, content, author_id, like_num, publish_time) values ('文章标题2', '文章内容2', 1, 10, '2025-01-9 15:01:02');
insert into article(title, content, author_id, like_num, publish_time) values ('文章标题3', '文章内容3', 1, 10, '2025-01-9 15:01:03');
