...
type ThumbupRequest struct {
	...
	ObjId    int64  `protobuf:"varint,2,opt,name=obj_id,json=objId,proto3" json:"obj_id,omitempty"`          // 点赞对象id
	UserId   int64  `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`       // 用户id
	LikeType int32  `protobuf:"varint,4,opt,name=like_type,json=likeType,proto3" json:"like_type,omitempty"` // 类型
}
...
type ThumbupResponse struct {
	...
	BizId      string `protobuf:"bytes,1,opt,name=biz_id,json=bizId,proto3" json:"biz_id,omitempty"`                 // 业务id
	ObjId      int64  `protobuf:"varint,2,opt,name=obj_id,json=objId,proto3" json:"obj_id,omitempty"`                // 点赞对象id
	LikeNum    int64  `protobuf:"varint,3,opt,name=like_num,json=likeNum,proto3" json:"like_num,omitempty"`          // 点赞数
	DislikeNum int64  `protobuf:"varint,4,opt,name=dislike_num,json=dislikeNum,proto3" json:"dislike_num,omitempty"` // 点踩数
}
...
type IsThumbupRequest struct {
	...
	BizId    string `protobuf:"bytes,1,opt,name=biz_id,json=bizId,proto3" json:"biz_id,omitempty"`           // 业务id
	TargetId int64  `protobuf:"varint,2,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"` // 点赞对象id
	UserId   int64  `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`       // 用户id
}
...
type IsThumbupResponse struct {
	...
	UserThumbups map[int64]*UserThumbup `protobuf:"bytes,1,rep,name=user_thumbups,json=userThumbups,proto3" json:"user_thumbups,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type UserThumbup struct {
	...
	UserD       int64 `protobuf:"varint,1,opt,name=user_d,json=userD,proto3" json:"user_d,omitempty"`
	ThumbupTime int64 `protobuf:"varint,2,opt,name=thumbup_time,json=thumbupTime,proto3" json:"thumbup_time,omitempty"`
	LikeType    int32 `protobuf:"varint,3,opt,name=like_type,json=likeType,proto3" json:"like_type,omitempty"` // 类型
}
...
func (x *UserThumbup) GetUserD() int64 {
	if x != nil {
		return x.UserD
	}
	return 0
...
var file_like_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x42, 0x0a, 0x09, 0x49, 0x73, 0x54, 0x68, 0x75, 0x6d,
	0x62, 0x75, 0x70, 0x12, 0x19, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x49, 0x73,
	0x54, 0x68, 0x75, 0x6d, 0x62, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x49, 0x73, 0x54, 0x68, 0x75, 0x6d, 0x62,
...
var file_like_proto_depIdxs = []int32{
	5, // 0: service.IsThumbupResponse.user_thumbups:type_name -> service.IsThumbupResponse.UserThumbupsEntry
